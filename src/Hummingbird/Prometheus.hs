...
data Metrics
  = Metrics
  { hummingbird_connections_accepted_total    :: P.Counter
  , hummingbird_connections_rejected_total    :: P.Counter
  , hummingbird_connections_closed_total      :: P.Counter
  , hummingbird_connections_failed_total      :: P.Counter
  , hummingbird_publications_upstream_total   :: P.Counter
  , hummingbird_publications_downstream_total :: P.Counter
  }
